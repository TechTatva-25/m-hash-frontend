				...
				>					{/* Enhanced inner glow with subtle highlights */}
					...
					<div className="relative flex flex-col h-full justify-between gap-2 z-10">
						...
						<div className="flex flex-col flex-1 min-h-0 relative">
							{/* Subtle background for better text readability in light mode */}							<div className="absolute inset-0 bg-white/25 rounded-lg -z-10"></div><h3
								className="text-xl/[1.3] font-semibold text-balance truncate"								style={{
							...
							>
								{stage.date}
							</h2>							{/* Description text with increased size for better readability */}
							<div
								className="text-sm/[1.4] overflow-y-auto flex-1 pr-1.5 scrollbar-thin scrollbar-thumb-indigo-200 scrollbar-track-transparent pb-3"								style={{
