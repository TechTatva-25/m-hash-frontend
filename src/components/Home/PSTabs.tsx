		...
		>
			<div className="container mx-auto px-4">
				...
				>
					...
					<div className={`absolute top-4 right-4 w-8 h-8 rounded-full blur-sm ${
						isDark ? "bg-[rgba(103,80,164,0.3)]" : "bg-[rgba(132,95,220,0.2)]"
					}`}></div>
					<div className={`absolute bottom-4 left-4 w-6 h-6 rounded-full blur-sm ${
						isDark ? "bg-[rgba(103,80,164,0.3)]" : "bg-[rgba(132,95,220,0.2)]"
					}`}></div>

					{!problems.length ? (
						<div className="flex justify-center items-center py-20">
							<Spinner className={isDark ? "text-[rgba(220,200,255,0.9)]" : "text-[rgba(103,80,164,0.9)]"} size="large" />
						</div>
					) : (
