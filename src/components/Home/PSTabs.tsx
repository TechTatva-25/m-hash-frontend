				...
				<motion.div
					...
					{!problems.length ? (
						...
						<Tabs defaultValue="all" className="w-full relative z-10" onValueChange={handleTabChange}>
							<TabsList
								className={`mx-auto mb-6 sm:mb-8 md:mb-12 flex w-fit flex-col items-center space-y-2 rounded-xl backdrop-blur-md transition-all duration-300 p-2 sm:p-3 ${
									isDark
										? "bg-[rgba(30,30,40,0.6)] border border-[rgba(103,80,164,0.3)]"
										: "bg-[rgba(255,255,255,0.7)] border border-[rgba(132,95,220,0.3)]"
								} md:flex-row md:justify-center md:space-x-2 lg:space-x-4 md:space-y-0`}
								style={{
									boxShadow: isDark
