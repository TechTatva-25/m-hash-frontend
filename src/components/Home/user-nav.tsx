							   ...
							   <DropdownMenuContent 
									   ...
									   <DropdownMenuLabel className="font-normal">
											   <div className="flex flex-col space-y-1">
													   <p className={isDark ? "text-[rgba(220,200,255,0.9)]" : "text-[rgba(103,80,164,0.9)]" + " text-sm font-medium leading-none"}>{username}</p>
													   <p className={isDark ? "text-[rgba(200,180,240,0.7)]" : "text-[rgba(103,80,164,0.7)]" + " text-xs leading-none"}>{userEmail}</p>
											   </div>
									   </DropdownMenuLabel>
									   <DropdownMenuSeparator />
									   <DropdownMenuGroup>
											   <DropdownMenuItem 
                                 className={`hover:cursor-pointer text-current ${isDark 
                                 ...
                                 asChild>
													   <Link href="/dashboard" className="flex items-center">
															   <LayoutGrid className={isDark ? "mr-3 h-4 w-4 text-[rgba(220,200,255,0.7)]" : "mr-3 h-4 w-4 text-[rgba(103,80,164,0.7)]"} />
															   <span className={isDark ? "" : "text-[rgba(50,50,50,0.9)] hover:text-[rgba(50,50,50,1)]"}>Dashboard</span>
													   </Link>
											   </DropdownMenuItem>
									   </DropdownMenuGroup>
									   <DropdownMenuSeparator />
                                           ...
                                           : "hover:bg-[rgba(132,95,220,0.08)] hover:text-[rgba(50,50,50,1)]")
													   ...
													   onClick={signOut}
													   disabled={disabled}>
													   <LogOut className={isDark ? "mr-3 h-4 w-4 text-[rgba(220,200,255,0.7)]" : "mr-3 h-4 w-4 text-[rgba(103,80,164,0.7)]"} />
													   <span className={isDark ? "" : "text-[rgba(50,50,50,0.9)] hover:text-[rgba(50,50,50,1)]"}>Sign out</span>
											   </DropdownMenuItem>
							   </DropdownMenuContent>
					   </DropdownMenu>
			   </div>
