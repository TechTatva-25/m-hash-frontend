...
const TeamCard = ({
	...
	return (
		<Card className="mb-4 group relative backdrop-blur-xl rounded-xl shadow-lg overflow-hidden transition-all duration-500 hover:shadow-xl hover:scale-[1.01]"
			style={{
				background: isDark 
			...
			<CardContent className="grid gap-2 p-3 sm:p-6 relative z-10">
				<div className="flex items-center justify-between">
					...
					<Badge className="hidden sm:flex backdrop-blur-xl" variant="secondary" style={{
						background: isDark
...
export default function JoinTeam(): React.JSX.Element {
	...
	return (
		<Card className="group relative backdrop-blur-xl rounded-xl shadow-lg overflow-hidden transition-all duration-500 hover:shadow-xl hover:scale-[1.01]"
			style={{
				background: isDark 
					? 'linear-gradient(to bottom right, rgba(30, 41, 59, 0.7), rgba(15, 23, 42, 0.8))'
					: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.8), rgba(241, 245, 249, 0.9))',
			...
			<CardHeader className="relative z-10">
				<div className="relative inline-block mb-4">
					<CardTitle className="text-3xl font-bold text-[hsl(var(--foreground))]" style={{ fontFamily: "var(--font-playfair-display)" }}>Join Team</CardTitle>
				...
				<CardDescription className="text-[hsl(var(--foreground))]/80">Join a team by entering the team name.</CardDescription>
			</CardHeader>
			<CardContent className="relative z-10 px-2 pb-2 sm:px-6 sm:pb-6">
				...
				/>
				<ScrollArea className="mt-2 h-[420px] overflow-auto overflow-x-hidden rounded-md" style={{
					background: isDark 
