...
export const InvitesInbox: React.FC<{
	...
	return (
		...
		>
			...
			<CardContent className="relative z-10">				<Tabs defaultValue="incoming">
					<TabsList 
					...
					</TabsList>					<TabsContent value="incoming">
										...
										<CardContent className="flex flex-row items-center justify-between px-2 py-3 relative z-10">
											<div className="flex items-center gap-2">
												<div className="relative">
													...
													/>
													<div className="absolute inset-0 rounded-full blur-sm opacity-50" style={{
														background: isDark ? 'rgba(139, 92, 246, 0.2)' : 'rgba(139, 92, 246, 0.1)'
													}}></div>
												</div>
												<div className="flex flex-col">
													<div className="text-lg font-medium" style={{ fontFamily: "var(--font-playfair-display)" }}>{invite.team.name}</div>													<p className="text-xs text-muted-foreground">
														Invited by{" "}
											...
											<div className="flex items-center gap-2">
												<Button
													...
													<FaCheck className="h-4 w-4" color={isDark ? '#4ade80' : '#16a34a'} />
												</Button>
												<Button
													className="h-8 w-8 p-0 disabled:opacity-50 transition-all duration-300 backdrop-blur-sm"
													style={{
					...
					</TabsContent>					<TabsContent value="outgoing">
						<ScrollArea className="mt-4 h-[420px] overflow-auto overflow-x-hidden pr-2">
							{invites
