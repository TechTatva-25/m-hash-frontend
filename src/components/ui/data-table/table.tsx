...
export default function DataTable<TableProps>({
	...
	const tableStyles = {
		...
		row: (isSelected: boolean) => ({
			background: isSelected ? (isDark ? "rgba(139, 92, 246, 0.15)" : "rgba(139, 92, 246, 0.1)") : "transparent",
	...
	return (
		<div className={cn("w-full rounded-xl", classNames)} style={tableStyles.container}>
			...
			<Table>
				...
				<TableHeader>
					{table.getHeaderGroups().map((headerGroup) => (
						<TableRow key={headerGroup.id} style={tableStyles.headerRow} className="border-0">
