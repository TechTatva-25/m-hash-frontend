...
interface MultipleSelectorProps {
	...
	optionNode?: (option: Option) => React.ReactNode;
	/** async search */
...
const MultipleSelector = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
	(
		...
		const CreatableItem = (): React.JSX.Element | undefined => {
			...
			<Command
				...
				<div
					...
					<div className="flex flex-wrap gap-1">
							...
							return (
								<Badge
									...
									<button
										...
										onClick={(): void => handleUnselect(option)}>
						...
						<button
							type="button"
							onClick={(): void => setSelected(selected.filter((s) => s.fixed))}
							className={cn(
								(hideClearAllButton ||
									disabled ||
									selected.length < 1 ||
