	...
	return (
		<ContentLayout title="Leaderboard">
			...
			<div className="container mx-auto max-w-4xl p-4">
				<h1 className="mb-6 text-center text-3xl font-bold">Bug Bounty Leaderboard</h1>
					...
					<Table>
						...
						<TableBody>
							{currentTeams.map((team, index) => (
								<TableRow key={team.id} className={index < 3 ? "font-medium" : ""}>
									...
									<TableCell className="text-right">
										{moment(team.lastSubmission).fromNow()}
									</TableCell>
								</TableRow>
							))}
						</TableBody>
