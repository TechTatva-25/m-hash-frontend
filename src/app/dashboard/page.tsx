					...
					<>
						{currentTeam.team_leader._id === session.user._id && currentTeam.members.length === 1 && (
							<Alert
								...
								style={{
									background: isDark ? "rgba(234, 179, 8, 0.05)" : "rgba(234, 179, 8, 0.05)",
								...
								<div className="relative z-10 flex items-center">
									...
									<div>
										...
										<AlertDescription className="ml-2">
											You are the only member of this team. Please invite at least one more member
											to be eligible for Round 1.
										</AlertDescription>
									</div>
								</div>
							</Alert>
